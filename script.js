const menus = [
    {
        "name": "chicken_burger",
        "label_name": "Chicken Burger",
        "harga": 50000,
    },
    {
        "name": "french_fries",
        "label_name": "French Fries",
        "harga": 35000,
    },
    {
        "name": "hot_dog",
    ...
    {
        "name": "cappucino_cincau",
        "label_name": "Cappucino Cincau",
        "harga": 40000,
    },
];
...
const showBarang = () => {
    ...
    dataBarang.forEach((element, i) => {
        listBarang.innerHTML += `<div class="card" id="card-${element[1]}" style="background-color: #007bff;">
        <div class="card-body">
